...
public class Execute {
    ...
    public static void execute(boolean isFromFile, MyTreeMap map, Scanner SCANNER,
        ...
        do {
            ...
            switch (execCom) {
                case "sign_in":
                    new AuthorizationCommand(client);
                    return;
                case "create_a_client":
            ...
            try {
                ...
                ExecuteRequest.setStateAnswer(ReportState.SERVER_DIE);
                e.printStackTrace();
            } catch (InvalidPasswordException e) {
                throw e;
            } if (client.idOfClient == null) {
                throw new IllegalCommandException("Unknown user, you must be authorization");
            }
